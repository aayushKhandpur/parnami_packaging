class OrderProductsController < ApplicationController
    ...
    def order_product_params
      params.permit(:master_product_id, :order_id, :size, :color, :print_type, :print_scheme, :ink_color, :gsm, :is_velcrow, :is_dori, :is_chain, :is_tape, :lamination, :font_pattern, :side_fabric_color, :dori_color, :price_per_kg, :price_per_piece, :quantity, :order_id)
    end
